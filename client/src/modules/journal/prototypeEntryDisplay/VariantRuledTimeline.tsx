// PROTOTYPE - variant A: entries as a ruled, month-grouped timeline (no cards).
...
export interface VariantRuledTimelineProps {
  entries: Entry[];
}

export function VariantRuledTimeline({ entries }: VariantRuledTimelineProps) {
